BEGIN;
INSERT INTO `playlist` (`id`, `name`, `description`, `type`, `cover_url`, `status`, `recommended`, `special`,
                        `recommend_factor`, `creator_id`, `created_time`, `updated_time`)
VALUES ('2ApcWNEFCSCBwQNlgThhGR0tFvL', '测试歌单', '测试歌单详情信息', '华语',
...
INSERT INTO `playlist` (`id`, `name`, `description`, `type`, `cover_url`, `status`, `recommended`, `special`,
                        `recommend_factor`, `creator_id`, `created_time`, `updated_time`)
VALUES ('2ApccuQqKpt7kbFl46SVEgNjMQJ', '测试歌单1', '测试歌单详情信息', '粤语',
...
INSERT INTO `playlist` (`id`, `name`, `description`, `type`, `cover_url`, `status`, `recommended`, `special`,
                        `recommend_factor`, `creator_id`, `created_time`, `updated_time`)
VALUES ('2ApcdJJ6K6QtbCO2bwyPN7YhlMA', '测试歌单2', '测试歌单详情信息', '欧美',
...
INSERT INTO `playlist` (`id`, `name`, `description`, `type`, `cover_url`, `status`, `recommended`, `special`,
                        `recommend_factor`, `creator_id`, `created_time`, `updated_time`)
VALUES ('2ApcdW2zUdhfcUrFX0rItzuzSyg', '测试歌单3', '测试歌单详情信息', '日韩',
...
INSERT INTO `playlist` (`id`, `name`, `description`, `type`, `cover_url`, `status`, `recommended`, `special`,
                        `recommend_factor`, `creator_id`, `created_time`, `updated_time`)
VALUES ('2Apcdo1nxQolk5d7hShaoCGLcTj', '测试歌单4', '测试歌单详情信息', '轻音乐',
